...
import UpdateInstructor from './instructor.update.component';
import DeleteInstructor from './instructor.delete.component';
    ...
    render(){
        return(
            <Router>
                ...
                <Route path="/instructorUpdate" component={UpdateInstructor}/>
                <Route path="/instructorDelete" component={DeleteInstructor}/>
            </Router>
        )
    }
}